...
const CarouselEquipo = () => {
  ...
  const equipo = [
    {
      nombre: 'Lu',
      descripcion: 'Responsable del entrenamiento en el box. Co-Owner, atleta de CrossFit… y la culpable de que sufras en cada WOD.',
    ...
    {
      nombre: 'Sergi',
      descripcion: 'Co-Owner del box. Le encontrarás entrenando, ayudando… o metiéndose contigo (con cariño).',
      rol: 'Co-Owner',
      imagen: '/sergi.webp',
    ...
    {
      nombre: 'Saray',
      descripcion: 'Saray, la Srta. Inkisidora. Coach del box, siempre dispuesta a ayudarte a mejorar cada día.',
      rol: 'Coach',
      imagen: '/saray.webp',
      especialidades: ['Crossfit', 'Halterofilia', 'Gymnastics'],
      imagenClasses: '',
    ...
    },
    {
      ...
      rol: 'Coach',
      imagen: '/borja.webp',
      especialidades: ['Mobilidad', 'Fisioterapia', 'Gymnastics'],
      imagenClasses: 'top-50',
    },
  ];
