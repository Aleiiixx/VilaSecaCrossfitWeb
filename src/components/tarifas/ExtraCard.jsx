...
const ExtraCard = ({ tituloBono, precio, caracteristicas, descripcionExtra }) => {
  return (
    <div className="flex flex-col items-center w-[400px] min-w-[300px] max-h-[600px] max-w-[450px] bg-[#c3dedc] p-1 shadow-lg rounded-2xl overflow-hidden">
      <div className="w-full h-full rounded-2xl py-4 px-6 gap-4">
        <div className="flex flex-col w-full py-4">
          ...
          <div className="flex flex-row justify-center items-end">
            ...
            <p className="text-sm text-theme-background-gray text-center pb-1">&nbsp;/mes</p>
          </div>
        </div>

        {caracteristicas.map((caracteristica, index) => (
          <div key={index} className="flex flex-row pl-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-9 h-9 text-primary-blue" viewBox="0 0 24 24" fill="currentColor">
